...
**Reference:** See `scientific-method.md` for detailed principles and `experimental-design.md` for comprehensive design checklist.
...
**Reference:** See `common-biases.md` for comprehensive bias taxonomy with detection and mitigation strategies.
...
**Reference:** See `statistical-pitfalls.md` for detailed pitfalls and correct practices.
...
**Reference:** See `evidence-hierarchy.md` for detailed hierarchy, GRADE system, and quality assessment tools.
...
**Reference:** See `logical-fallacies.md` for comprehensive fallacy catalog with examples and detection strategies.
...
**Reference:** See `experimental-design.md` for comprehensive design checklist covering all stages from question to dissemination.
...
- **`scientific-method.md`** - Core principles of scientific methodology, the scientific process, critical evaluation criteria, red flags in scientific claims, causal inference standards, peer review, and open science principles

- **`common-biases.md`** - Comprehensive taxonomy of cognitive, experimental, methodological, statistical, and analysis biases with detection and mitigation strategies

- **`statistical-pitfalls.md`** - Common statistical errors and misinterpretations including p-value misunderstandings, multiple comparisons problems, sample size issues, effect size mistakes, correlation/causation confusion, regression pitfalls, and meta-analysis issues

- **`evidence-hierarchy.md`** - Traditional evidence hierarchy, GRADE system, study quality assessment criteria, domain-specific considerations, evidence synthesis principles, and practical decision frameworks

- **`logical-fallacies.md`** - Logical fallacies common in scientific discourse organized by type (causation, generalization, authority, relevance, structure, statistical) with examples and detection strategies
