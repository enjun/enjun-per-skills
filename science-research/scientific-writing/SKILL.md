...
- `main.tex` - IEEE-style article template for wireless communications (includes custom commands for wireless notation)
- `IEEEtran.cls` - IEEE document class
- `IEEEtran.bst` - IEEE bibliography style
- `IEEEabrv.bib` - IEEE standard abbreviations
- `myref.bib` - Example bibliography file with wireless communications reference
