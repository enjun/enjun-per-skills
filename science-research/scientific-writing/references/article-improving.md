...
```
Use the `scientific-thinking` skill's critical analysis reference (`references/critical-thinking.md`) on `latex/main.tex`
```
...
```
Consult: [writing-requirements.md](writing-requirements.md)
```
...
📖 **For Related Work Issues**: If literature assessment reveals problems with the Related Work section, consult [related-work-improvement.md](related-work-improvement.md) for targeted improvement strategies.
...
- [improvement-strategies.md](improvement-strategies.md) - Quick fixes by category (methodology, statistics, logic, clarity, citations)
- [related-work-improvement.md](related-work-improvement.md) - Related Work section improvement strategies
...
📖 **Quick Reference Guide**: For detailed strategies and examples for each category, consult [improvement-strategies.md](improvement-strategies.md)

**Special Focus - Related Work**: When improving literature review sections, use [related-work-improvement.md](related-work-improvement.md) for:
...
⚠️ **Writing Requirements Check** (see [writing-requirements.md](writing-requirements.md)):
...
|------|---------|-------------|
| `Skill: scientific-thinking` (critical mode) | Comprehensive paper evaluation | Phase 1: Analysis |
...
|----------|---------|-------------|
| **[improvement-strategies.md](improvement-strategies.md)** | Quick fix strategies by category | Implementing specific improvements |
| **[related-work-improvement.md](related-work-improvement.md)** | Related Work improvement guide | Improving literature review |
| **[writing-requirements.md](writing-requirements.md)** | Data authenticity, mathematical proofs, LaTeX formatting | Ensuring paper quality and formatting standards |
