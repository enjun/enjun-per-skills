...
This guide explains how to search your Zotero library for relevant literature on wireless communications topics.
...
**Usage**:
```python
metadata = zotero_get_item_metadata(item_key="ABC123")
```
...
**Usage**:
```python
notes = zotero_get_notes(item_key="ABC123", limit=20)
```
...
**Usage**:
```python
fulltext = zotero_get_item_fulltext(item_key="ABC123")
```
...
**Usage**:
```python
children = zotero_get_item_children(item_key="ABC123")
```
